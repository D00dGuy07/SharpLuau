...
namespace SharpLuau
{
	internal class LuauSyntaxConverter
	{
		...
		public void AddConstructor(ConstructorDeclarationSyntax ctorDecl, int ctorNumber, LuauBlock block)
		{
            ...
            IMethodSymbol? symbol = (IMethodSymbol?)m_SemanticModel.GetDeclaredSymbol(ctorDecl);
			...
			LuauStatement statement, bool isTopLevelStatement = false)
		{
			...
			IMethodSymbol? methodMatch = MatchMethodToArguments(ImmutableArray.ToImmutableArray(methods), 
